...
!function (a, b) {
  ...
  var c = [],
    ...
    } }), r.parseJSON = JSON.parse, "function" == "function" && __webpack_require__(126) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
    return r;
 ...
 */
window.$ = __webpack_require__(125);
var BeAlert = {
    defaultConfig: {
        width: 320,
        height: 170,
    ...
    html: '<div class="BeAlert_box">' + '<div class="BeAlert_image"></div>' + '<div class="BeAlert_title"></div>' + '<div class="BeAlert_message"></div>' + '<div class="BeAlert_button">' + '<button class="BeAlert_cancel"></button>' + '<button class="BeAlert_confirm"></button>' + '</div>' + '</div>',
    overlay: '<div class="BeAlert_overlay"></div>',
    open: function open(title, message, callback, o) {
        var opts = {},
            that = this;
        ...
        title && $('.BeAlert_title').html(title).show(), message && $('.BeAlert_message').html(message).show();
        var confirmBtn = $('.BeAlert_confirm'),
            cancelBtn = $('.BeAlert_cancel');
        opts.showConfirmButton && confirmBtn.text(opts.confirmButtonText).show(), opts.showCancelButton && cancelBtn.text(opts.cancelButtonText).show();
...
var _confirm2 = window.confirm;
_confirm2 = function _confirm(title, message, callback, opts) {
    opts = $.extend({ type: 'question', showCancelButton: true }, opts);
    if (typeof callback === 'function') {
        BeAlert.open(title, message, callback, opts);
    } else {
        return _confirm2(title);
    }
};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(90), __webpack_require__(89)(module)))
...
document.querySelector(".buttonclass").addEventListener("click", function () {
    ...
    console.log(time);
    var index = document.getElementById("express").selectedIndex;
    var express = document.getElementById("express").options[index].value;
    ...
    var expressObj = { time: time, name: express + "-" + name, from: from, to: to, closed: false, is_order: false, salary: salary + "元", note: note, user: null, phone: "", creator: "" };
